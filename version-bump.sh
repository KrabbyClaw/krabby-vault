...
# Update version file for website
echo "$NEW_VERSION" > VERSION
echo "Updated VERSION file"

# Create version.ts for Next.js
cat > app/version.ts << EOF
// Auto-generated version file
// Updated by version-bump.sh on $(date -u +"%Y-%m-%dT%H:%M:%SZ")
...
echo "Commit amended with version files"
